...
\rok{2023}
\cislo{1--2}
\doisufix{2023-1-2/\thepage}
\uzaverka 30.6.2023  %
\naklad{250}
\CSBULilustrace{Vít Starý Novotný}
\makeatletter
  \bul@rr@toks{%
...
\Obalka[%
  ...
  \begin{minipage}{64mm}%
    \centering
    \raisebox{0mm}{%
      \input Novotny-jmena/figures/language-model-1-title-page
    }%
  \end{minipage}%
]
...
\PDFclanek[Sojka-uvodnik]{uvodnik}
\PDFclanek[Novotny-jmena]{main}
\PDFclanek[Sebela-hudba]{main}
\PDFclanek[Vancik-TikZBricks]{Zapoctovy_dokument}
\PDFclanek[Wilson-glisterings]{14}
